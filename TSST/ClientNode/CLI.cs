...
namespace ClientNode
{
    ...
    class CLI
    {
        ...
        /// </summary>
        public static readonly string managerError = "Nie udało mi się zrobić wszystkiego tak jak chciałeś i wysyłam errora";
        ...
        /// <param name="message">treść wiadomości</param>
        /// <param name="port">numer portu</param>
        public static void PrintSentMessage(string message)
        {
            Console.WriteLine($"{DateTime.Now} Wysłano {message}");
        }
        ...
        {
            Console.WriteLine($"{DateTime.Now} Zlapany wyjatek:\n {e.ToString()}" );
        }
    }
}